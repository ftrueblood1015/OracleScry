...
namespace OracleScry.Infrastructure.Migrations
{
    ...
    [Migration("20260205224550_AddDeckTemplates")]
    partial class AddDeckTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OracleScry.Domain.Entities.DeckTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ScryfallDeckId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("DeckTemplates");
                });

            modelBuilder.Entity("OracleScry.Domain.Entities.DeckTemplateCard", b =>
                {
                    b.Property<Guid>("DeckTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("DeckTemplateId", "CardId");

                    b.HasIndex("CardId");

                    b.HasIndex("DeckTemplateId");

                    b.HasIndex("IsCommander");

                    b.HasIndex("IsSideboard");

                    b.ToTable("DeckTemplateCards");
                });
            ...
            modelBuilder.Entity("OracleScry.Domain.Entities.DeckTemplateCard", b =>
                {
                    ...
                    b.HasOne("OracleScry.Domain.Entities.DeckTemplate", "DeckTemplate")
                        .WithMany("TemplateCards")
                        .HasForeignKey("DeckTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
